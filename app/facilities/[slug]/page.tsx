...
export default function FacilityDetailPage({ params }: FacilityDetailPageProps) {
  ...
  const facilityName = findLabelBySlug(facilityNames, params.slug)
  ...
  return (
    <main className="px-6 py-12 pt-28">
      <PageWrapper>
        ...
        <div className="mb-8">
          <PreviewGate compact description="Create an account to save this facility, upload your own workbook, and export comparison views." />
        </div>
